...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { direccion: @empleado.direccion, email: @empleado.email, nombre: @empleado.nombre, ruc: @empleado.ruc, telefono: @empleado.telefono } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { direccion: @empleado.direccion, email: @empleado.email, nombre: @empleado.nombre, ruc: @empleado.ruc, telefono: @empleado.telefono } }
