class Proceso < ApplicationRecord
	...
	validates :cliente_id, :empleado_id, :estado_id, :institucion_id, :fecha_ingreso, :doc_numero, :referencia, :presence => { message: "campo obligatorio" }
	...
	#scope :sorted_by_doc_numero, -> doc_numero { Proceso.where('doc_numero = ?', Integer(doc_numero))}
